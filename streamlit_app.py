...
# Simplified constants - uses current user's schema automatically
CORTEX_SEARCH_DOCUMENTATION = "DOCS"  # Will use current schema context
SEMANTIC_MODEL = "@semantic_files/semantic_search.yaml"  # Will use current schema context
...
def main():
    st.title("Intelligent Sales Assistant - Multi-User Lab")
    ...
    with st.sidebar:
        ...
        try:
            ...
            st.write("Context information unavailable")
